...
import { Matrix, Object2D, Transform2d, Vec2 } from "@repcomm/scenario2d";
...
export class Cursor extends Object2D {
  ...
  addTextPos(tx: number = 1, ty: number = 0) {
...
async function main() {
  ...
  function canvasToTextIndex (v: Vec2, out: Vec2, floor: boolean = true) {
    out.copy(v);
  ...
  function canvasToChunkIndex (v: Vec2, out: Vec2, floor: boolean = true) {
